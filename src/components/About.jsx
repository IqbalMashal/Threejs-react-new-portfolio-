        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://www.linkedin.com/in/iqbalmashal//", "_blank")}
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://github.com/IqbalMashal", "_blank")}
            >
        ...
        >
          ...
          >
            ...
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.2, 0.75)}>
              <span className="mr-4 text-2xl flex-shrink-0">🎓</span>
              <span>
                Currently studying Computer Programming & Analysis (CPA) at Seneca College, with plans to transfer to Ontario Tech University to pursue my Honours Bachelor of Science in Computer Science. I’m passionate about building reliable, scalable software that makes a difference.
              </span>
            </motion.li>
